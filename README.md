...
<h3 align="center">F3-Booster</h3>

<p align="center">A Simple, Fast and Efficient <a href="https://play.google.com/store/apps/details?id=cool.f3">F3</a> Affiliate Link Booster</p>
...
## FAQ
- **Q: How to use F3?**
- A: You must first download the requirements with the command `pip install -r requirements.txt` and then follow the instructions after starting F3-Booster with the command `python main.py`. You can also run the downloadable executable directly from the [Releases](https://github.com/TurfuFrogy/F3-Booster/releases).
